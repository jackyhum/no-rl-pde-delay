...
def main():
    ...
    spatialDelayParameters = {
            ...
            "c1": c1,
            "spatial": spatial,
            "reward_class": SpatialDelayReward(int(round(T/dt)), N1, 2 , -1e3, 200, 10),
            "normalize":True,  
    ...
    if retrain:
        ...
        model.save("./PDEControlGym/Model/spatial_delay_model.zip")
        print("*---------训练结束-----------*")
    ...
    plt.savefig('./PDEControlGym/pics/RONET/test3.png', dpi=300, bbox_inches='tight', pad_inches=0.3)
    # plt.show()
    ...
    plt.savefig('./PDEControlGym/pics/RONET/control3.png', dpi=300, bbox_inches='tight')
    ...
    plt.xlabel(r"$t(\text{sec})$",fontsize="13")
    plt.tick_params(labelsize=13)
    plt.savefig('./PDEControlGym/pics/RONET/L2.png', dpi=300, bbox_inches='tight')

    np.savez("./PDEControlGym/pics/DataForPics/ronet_data.npz", time = time2, ronet_control = u[:, N1 ], ronet_l2 = interL2)
